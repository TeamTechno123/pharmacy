...
/*******************************    User Information      ****************************/
  ...
  //   $pharm_role_id = $this->session->userdata('pharm_role_id');
  //   if($pharm_user_id == '' && $pharm_company_id == ''){ header('location:'.base_url().'User'); }
  //   $data['user_list'] = $this->User_Model->user_list($pharm_company_id);
  //   $this->load->view('Include/head',$data);
  //   $this->load->view('Include/navbar',$data);
  ...
  //   }
  //   $data['group_list'] = $this->Master_Model->get_list_by_id2($pharm_company_id,'','','','','group_name','ASC','group');get_list_by_id('company_id',$pharm_company_id,'','','group_name','ASC','group');
  //   $data['role_list'] = $this->Master_Model->get_list_by_id2('','','','','','role_name','ASC','role');
  //   $data['branch_list'] = $this->Master_Model->get_list_by_id2($pharm_company_id,'','','','','branch_name','ASC','branch');
  //   $this->load->view('Include/head', $data);
  //   $this->load->view('Include/navbar', $data);
  ...
  //     $update_data['user_status'] = $user_status;
  //     $update_data['company_id'] = $pharm_company_id;
  //     $update_data['user_addedby'] = $pharm_user_id;
  ...
  //   $data['update'] = 'update';
  //   $data['user_info'] = $user_info[0];
  //   $data['group_list'] = $this->Master_Model->get_list_by_id2($pharm_company_id,'company_id',$pharm_company_id,'','','group_name','ASC','group');
  //   $data['role_list'] = $this->Master_Model->get_list_by_id2('','','','','','role_name','ASC','role');
  //   $data['branch_list'] = $this->Master_Model->get_list_by_id2($pharm_company_id,'company_id',$pharm_company_id,'','','branch_name','ASC','branch');
  //   $data['user_file_list'] = $this->Master_Model->get_list_by_id2($pharm_company_id,'user_id',$user_id,'','','user_file_id','ASC','user_file');
  //   $this->load->view('Include/head',$data);
  //   $this->load->view('Include/navbar',$data);
  //   $this->load->view('User/user',$data);
  //   $this->load->view('Include/footer',$data);
